...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                <div class="col-sm-2 col-form-label">
                    <strong class="field-title">Shift Time</strong>
                </div>
                <div class="col-sm-10 col-content">
                    {{ Form::select('shift_id', $shift, $data->shift_id, array('id' => 'shift_id', 'class' => 'form-control', 'required')) }}
                    <small class="form-text text-muted">
                        <i class="fa fa-question-circle" aria-hidden="true"></i> Select Shift time.
                    </small>
                </div>
            </div>
            @endif
